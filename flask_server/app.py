...
def api_post_connection():
    ...
    ssid = data["ssid"]
    send_connection_to_questdb(uuid_user, uuid_match, ssid, host=os.environ["QDB_HOST"], port=9000, username=os.environ["DB_USERNAME"], password=os.environ["DB_PASSWORD"])
